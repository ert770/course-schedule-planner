...
| 10 | 修復多方案塌縮：5 個 variant 實際只產出 2 種課表 | 🟡 部分完成（2026-09-18 更新）——必修安全邊界、涼度來源與興趣接線已修；#7 已用動態策略取代固定 variant。**候選池限制已隨 #13C 解除**（demo 帳號可競爭課程 16 → 365 門），且設定頁現可由使用者選正式修課路徑與候選課 `rag_tag` 主題，補上真實興趣輸入；但「本系優先」階層仍讓各方案在本系課程上高度重疊，2026-09-18 改動前實測 Persona C 2 種、U1 1 種方案；**仍需以目前版本重新量測**（推甄資料包 P0-5） | #4、#21、#22、#7、#13C（均已完成） |
...
**狀態**：🟡 部分完成（2026-08-31；2026-09-18 更新）——**排序機制的根因已修**，詳見
...
興趣」的入口，未改變必修優先或硬限制。興趣設定已完成瀏覽器 A/B；#10 維持部分完成，
等待現版方案數重測。
