...
> **2026-08-14 後續更新（#13B）**：本報告下方仍保留 2026-08-07 查核基準；班級資格部分的現況已更新。MySQL 現行 562 個相異班級名稱已全部分類：483 個一般 A 類、8 個特殊格式 A 類、71 個 B～F 類。搜尋回應會保留 `eligibility: unknown` 並由前端顯示「資格待確認」；排課器不再自動排入資格未知課程，使用者明確指定時才保留並警告。B～F 的正式適用規則仍待 roadmap #13C，不代表已確認誰能修。
