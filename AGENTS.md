...
- **推進 roadmap 任務時，`docs/CHANGE_REPORTS/2026-08-01-personalization-roadmap.md`
  進度總覽表的「狀態」與「相依」兩欄已核對過整張表**——不是只改動到的那一列。
  完成一項任務會讓下游任務的相依過期，而那時沒人在做下游，也就沒人會發現；
  被誤記為卡住的任務不會有人去碰，等於白白擱置。細節見該文件的〈文件性質〉。
